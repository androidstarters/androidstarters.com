...
import <%= appPackage %>.http.log.RequestInterceptor;
...
import <%= appPackage %>.mvp.model.api.Api;
 ...
 *
 * @see <%= appPackage %>.base.delegate.AppDelegate
 * @see <%= appPackage %>.integration.ManifestParser
