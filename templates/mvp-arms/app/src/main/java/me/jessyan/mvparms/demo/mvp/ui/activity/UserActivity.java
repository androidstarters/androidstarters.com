 ...
 */
package <%= appPackage %>.mvp.ui.activity;
...
import <%= appPackage %>.R;
import <%= appPackage %>.di.component.DaggerUserComponent;
import <%= appPackage %>.di.module.UserModule;
import <%= appPackage %>.mvp.contract.UserContract;
import <%= appPackage %>.mvp.presenter.UserPresenter;
