...
import static <%= appPackage %>.lifecycle.delegate.AppManager.APP_EXIT;
import static <%= appPackage %>.lifecycle.delegate.AppManager.KILL_ALL;
import static <%= appPackage %>.lifecycle.delegate.AppManager.SHOW_SNACKBAR;
import static <%= appPackage %>.lifecycle.delegate.AppManager.START_ACTIVITY;
