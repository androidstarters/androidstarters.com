package <%= appPackage %>.weather.mvvm.view.activity;
...
import <%= appPackage %>.weather.databinding.ActivityWeatherBinding;
import <%= appPackage %>.weather.mvvm.view.adapter.WeatherPagerAdapter;
