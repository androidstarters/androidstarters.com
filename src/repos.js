export var architectures = [{
    ...
    name: 'Buffer Kotlin Android Clean Architecture Boilerplate',
    templateName: 'buffer-clean-kotlin',
    license: 'MIT',
    ...
    gh: 'https://github.com/xiaobailong24/MVVMArms.git'
}];